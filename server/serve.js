...
// Check if static build exists at startup
if (!fs.existsSync(STATIC_ROOT)) {
  console.warn(`Warning: Static build directory not found at ${STATIC_ROOT}. Run build.js first.`);
}
...
function serveStaticFile(urlPath, res) {
  ...
  if (!fs.existsSync(STATIC_ROOT)) {
    ...
    res.end(JSON.stringify({ error: 'Static build not available. Run build.js first.' }));
    return;
  }
